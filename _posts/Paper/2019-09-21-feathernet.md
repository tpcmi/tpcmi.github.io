...
![](/img/feathernets/GAP&DWC.png)

Streaming module 是由一个深度分离卷积，并采用步长超过1的核进行下采样，然后再压缩成一个一维的特征向量：

![](/img/feathernets/Streaming module.png)

计算公式如下:

![](/img/feathernets/Steaming_module_compute_equation.png)

等式左边_FV_是被压缩的特征向量，具有_N=H’xW'xC_个元素，其中：

![](/img/feathernets/Streaming_module_nth.png)
